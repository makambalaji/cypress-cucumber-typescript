...
export const topologyPage = {
  ...
  clicKDisplayOptionDropdown: () =>
    cy.get("[id^=pf-select-toggle-id]").contains("Display Options").click(),
  ...
  getEventSource: (eventSource: string) => {
    return cy
      .get('[data-type="event-source"] g.odc-base-node__label > text')
  ...
  revisionNode: (serviceName: string) => {
    return cy
      ...
      .children(
        '[data-type="knative-revision"] circle[filter$="graph#NodeShadowsFilterId)"]'
      );
  },
...
export const topologySidePane = {
  ...
  verifyTitle: (nodeName: string) =>
    cy.get(topologyObj.sidePane.title).should("contain", nodeName),
  ...
  verifyTab: (tabName: string) =>
    cy.get(topologyObj.sidePane.tabs).contains(tabName).should("be.visible"),
  selectTab: (tabName: string) =>
    cy.get(topologyObj.sidePane.tabs).contains(tabName).click(),
  ...
  selectAddHealthChecks: () =>
    cy.get("a").contains("Add Health Checks").click(),
...
export const addHealthChecksObj = {
  readinessProbe: {
    requestType:
      "#form-dropdown-healthChecks-readinessProbe-data-requestType-field",
    ...
    failureThreshold:
      "#form-input-healthChecks-readinessProbe-data-failureThreshold-field",
    successThreshold:
      "#form-input-healthChecks-readinessProbe-data-successThreshold-field",
    initialDelay:
      "#form-input-healthChecks-readinessProbe-data-initialDelaySeconds-field",
    period: "#form-input-healthChecks-readinessProbe-data-periodSeconds-field",
    timeout:
      "#form-input-healthChecks-readinessProbe-data-timeoutSeconds-field",
  },
  livenessProbe: {
    requestType:
      "#form-dropdown-healthChecks-livenessProbe-data-requestType-field",
    httpHeaderName: 'input[placeholder="header name"]',
    httpHeaderValue: 'input[placeholder="value"]',
    ...
    failureThreshold:
      "#form-input-healthChecks-livenessProbe-data-failureThreshold-field",
    successThreshold:
      "#form-input-healthChecks-livenessProbe-data-successThreshold-field",
    initialDelay:
      "#form-input-healthChecks-livenessProbe-data-initialDelaySeconds-field",
  ...
  startupProbe: {
    requestType:
      "#form-dropdown-healthChecks-startupProbe-data-requestType-field",
    httpHeaderName: 'input[placeholder="header name"]',
    httpHeaderValue: 'input[placeholder="value"]',
    ...
    failureThreshold:
      "#form-input-healthChecks-startupProbe-data-failureThreshold-field",
    successThreshold:
      "#form-input-healthChecks-startupProbe-data-successThreshold-field",
    initialDelay:
      "#form-input-healthChecks-startupProbe-data-initialDelaySeconds-field",
