...
When(
  "user verifies that name of the node and route option is not editable",
  () => {
...
When(
  "user verifies that Application grouping, git url, builder image version and advanced option can be edited",
  () => {
...
When(
  "user verifies that name of service and route option is not editable",
  () => {
    // TODO: implement step
  }
);
...
Then(
  "user can see the change of node to the new Application {string}",
  (appName: string) => {
...
Then(
  "user can see the change of knative service to the new Application defined above",
  () => {
    // TODO: implement step
  }
);
