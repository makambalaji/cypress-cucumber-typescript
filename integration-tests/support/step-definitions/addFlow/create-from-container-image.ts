...
When(
  "user enters Image name from external registry as {string}",
  (imageName: string) => {
...
When(
  "user selects Project as {string} from internal registry",
  (projectName: string) => {
...
When(
  "user selects Image Stream as {string} from internal registry",
  (imageSrream: string) => {
