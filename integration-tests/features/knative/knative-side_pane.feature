...
Scenario: Side pane display for knative service : Kn-06-TC01
    ...
    Then side pane is displayed with heading name same as kantive service name "nodejs-ex-git-1"
...
@regression, @smoke
Scenario: Side pane details of for knative Revision : Kn-05-TC01, Kn-05-TC02
    Given knative service name "nodejs-ex-git-1" is higlighted on topology page
...
Scenario: Side pane details of knative Revision : Kn-05-TC02
    Given side pane is displayed for revision of kantive service "nodejs-ex-git-1" in topology page
